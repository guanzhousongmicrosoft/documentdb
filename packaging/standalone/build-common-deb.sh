...
install -m 0755 "${REPO_ROOT}/documentdb-local/scripts/documentdb_install_getparameter_stub.sh" \
    "${PKG_DIR}/usr/share/documentdb/scripts/documentdb_install_getparameter_stub.sh"
