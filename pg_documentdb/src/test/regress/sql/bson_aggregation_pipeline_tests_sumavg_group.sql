...
-- =============================================================================
-- Test 26: Collation is applied to the $sum accumulator's input expression
-- =============================================================================
...
-- minimum int64 leaving moving $sum and $avg windows
SELECT documentdb_api.insert_one('db','sumavg_int64_min_window','{ "_id": 1, "value": { "$numberLong": "-9223372036854775808" } }');
SELECT documentdb_api.insert_one('db','sumavg_int64_min_window','{ "_id": 2, "value": 1 }');
