...
pub struct QueryCatalog {
    ...
    pub find_bson_test_meta_qual: String,
    ...
    pub is_output_count_regex_1: String,
    pub is_output_count_regex_2: String,
...
impl QueryCatalog {
    ...
    pub fn find_bson_test_meta_qual(&self) -> &str {
        &self.find_bson_test_meta_qual
    }
    ...
    pub fn is_output_count_regex_1(&self) -> &str {
        &self.is_output_count_regex_1
    }

    pub fn is_output_count_regex_2(&self) -> &str {
        &self.is_output_count_regex_2
    }
...
pub fn create_query_catalog() -> QueryCatalog {
    QueryCatalog {
            ...
            // version.rs
            extension_versions: "SELECT ARRAY[
                  TRIM(BOTH '\"' FROM metadata->>'last_deploy_version')
                , documentdb_api.binary_version()
                , TRIM(BOTH '\"' FROM metadata->>'last_citus_version')
                , VERSION()
                , documentdb_api.binary_extended_version()
                , citus_version()
                ] FROM documentdb_api_distributed.documentdb_cluster_data".to_string(),
            ...
            set_explain_all_tasks_true: "SET LOCAL citus.explain_all_tasks = true".to_string(),
            ...
            find_bson_test_meta_qual: "documentdb_api_catalog.bson_text_meta_qual".to_string(),
            ...
            is_output_count_regex_1: "documentdb_api_catalog.".to_string(),
            is_output_count_regex_2: "BSONSUM('{ \"\" : { \"$numberInt\" : \"1\" } }'::documentdb_api_catalog.bson)".to_string(),
