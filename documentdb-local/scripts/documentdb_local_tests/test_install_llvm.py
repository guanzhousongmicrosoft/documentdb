...
"""Unit tests for scripts/install_llvm.sh.

Same stub-PATH harness as test_healthcheck.py: curl, sudo and wget are stubs
that record their argv, so the tests assert which install path the real
script picks for each apt.llvm.org response.
"""
