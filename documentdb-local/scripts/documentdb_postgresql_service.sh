...
main() {
    ...
    # via User=. start/stop/reload run as PG_OWNER (User= on the unit)
    # so the postmaster lives in the unit's cgroup and writes
    # postmaster.pid with ownership that matches PIDFile=.
