...
SET citus.next_shard_id TO 882000;
...
SELECT documentdb_distributed_test_helpers.drop_primary_key('geodb','geopushdown');
...
-- Results are correct across the find and @@ paths.
...
SELECT documentdb_distributed_test_helpers.drop_primary_key('geodb','geopushdown_pfe');
