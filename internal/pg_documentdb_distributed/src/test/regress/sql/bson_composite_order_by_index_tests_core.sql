...
SELECT documentdb_api.drop_database('comp_ordind_db') IS NOT NULL;
SELECT documentdb_api.create_collection('comp_ordind_db', 'query_orderby');

SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "query_orderby", "indexes": [ { "key": { "a": 1, "c": 1 }, "storageEngine": { "enableCompositeTerm": true }, "name": "a_c" }] }', true);

SELECT collection_id FROM documentdb_api_catalog.collections WHERE collection_name = 'query_orderby' AND database_name = 'comp_ordind_db' \gset

\d documentdb_data.documents_:collection_id

-- now insert some sample docs
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 1, "a": 1, "c": 1 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 2, "a": -2, "c": 2 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 3, "a": "string", "c": 2 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 4, "a": { "$minKey": 1 }, "c": 2 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 5, "a": true, "c": 2 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 6, "a": null, "c": 2 }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 7, "a": { "b": 1 }, "c": 2 }');
...
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gt": -100 }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gte": -2 }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gt": false }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gt": true }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gte": true }}, "sort": { "a": 1 } }');

-- validate runtime recheck functions
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$regex": "^str" }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$regex": "^str" }}, "sort": { "a": -1 } }');

SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$regex": "^abc" }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$regex": "^abc" }}, "sort": { "a": -1 } }');

-- validate ordering with truncation
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', FORMAT('{ "_id": 10, "a": "%s", "c": "%s" }', 'abcde' || repeat('z', 3000) || '2', 'cd1233')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', FORMAT('{ "_id": 11, "a": "%s", "c": "%s" }', 'abcde' || repeat('z', 3000) || '1', 'cd1234')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', FORMAT('{ "_id": 9, "a": "%s", "c": "%s" }', 'abcde' || repeat('z', 3000) || '3', 'cd1235')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', FORMAT('{ "_id": 12, "a": "%s", "c": "%s" }', 'abcde', 'cd1232'  || repeat('z', 3000) || '1')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', FORMAT('{ "_id": 13, "a": "%s", "c": "%s" }', 'abcde', 'cd1232')::bson);

SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "projection": { "_id": 1 }, "filter": { "a": { "$regex": "^abc" }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "projection": { "_id": 1 }, "filter": { "a": { "$regex": "^abc" }}, "sort": { "a": -1 } }');

-- validate sort works after an array is inserted
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby', '{ "_id": 8, "a": [ 1, 2, 3 ], "c": 2 }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby", "filter": { "a": { "$gt": -100 }}, "sort": { "a": 1 } }');

-- validate that we use disjoint sets more efficiently
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "query_orderby_perf_arr", "indexes": [ { "key": { "a": 1, "_id": 1 }, "enableCompositeTerm": true, "name": "a_1_id_1" }] }', true);

-- insert an array to make this a multi-key index
SELECT documentdb_api.insert_one('comp_ordind_db', 'query_orderby_perf_arr', '{ "_id": 0, "a": [ true, false ] }');

-- now insert documents 1 - 100
SELECT COUNT(documentdb_api.insert_one('comp_ordind_db', 'query_orderby_perf_arr', FORMAT('{ "_id": %s, "a": [ %s, %s ] }', i, i, 100 - i)::bson)) FROM generate_series(1, 100) AS i;

SELECT collection_id AS collection_id_2 FROM documentdb_api_catalog.collections WHERE collection_name = 'query_orderby_perf_arr' AND database_name = 'comp_ordind_db' \gset
...
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf_arr", "filter": { "a": { "$lt": 3 }}, "sort": { "a": 1 } }');

-- scans 1 loop for checking multi-key - then scans 5 loops for entries 96, 97, 98, 99, 100.
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf_arr", "filter": { "a": { "$gt": 96 }}, "sort": { "a": 1 } }');
...
---------------------------------------------------------------------------------
-- validate that we use disjoint sets more efficiently
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "query_orderby_perf", "indexes": [ { "key": { "a": 1, "_id": 1 }, "enableCompositeTerm": true, "name": "a_1" }] }', true);

-- now insert documents 1 - 100
SELECT COUNT(documentdb_api.insert_one('comp_ordind_db', 'query_orderby_perf', FORMAT('{ "_id": %s, "a": %s }', i, i)::bson)) FROM generate_series(1, 100) AS i;

SELECT collection_id AS collection_id_3 FROM documentdb_api_catalog.collections WHERE collection_name = 'query_orderby_perf' AND database_name = 'comp_ordind_db' \gset
...
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$lt": 3 }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$lt": 3 }}, "sort": { "a": -1 } }');

SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$gt": 96 }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$gt": 96 }}, "sort": { "a": -1 } }');

SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$lt": 94, "$gt": 90 }}, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "query_orderby_perf", "filter": { "a": { "$lt": 94, "$gt": 90 }}, "sort": { "a": -1 } }');
...
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "query_orderby_perf2", "indexes": [ { "key": { "b": 1, "c": 1 }, "enableCompositeTerm": true, "name": "b_1" }] }', true);

SELECT COUNT(documentdb_api.insert_one('comp_ordind_db', 'query_orderby_perf2', FORMAT('{ "_id": %s, "b": "%s", "c": %s }', i * 5 + j, repeat('aaaa', 10 * i), j)::bson)) FROM generate_series(50, 500) i JOIN generate_series(1, 5) AS j ON True;

SELECT collection_id AS collection_id_4 FROM documentdb_api_catalog.collections WHERE collection_name = 'query_orderby_perf2' AND database_name = 'comp_ordind_db' \gset

ANALYZE documentdb_data.documents_:collection_id_4;
...
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 1, "a": { "b": 1 } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 2, "a": { "b": null } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 3, "a": { "b": "string value" } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 4, "a": { "b": true } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 5, "a": { "b": false } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 6, "a": { "b": [] } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 7, "a": { "b": [1, 2, 3] } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 8, "a": { "b": [1, { "$minKey": 1 }, 3, true] } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 9, "a": { "b": [1, { "$maxKey": 1 }, 3, true] } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 10, "a": { "b": { "c": 1 } } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 11, "a": { "b": { "$maxKey": 1 } } }');

-- now some more esoteric values
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 12, "a": null }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 13, "a": [ {} ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 14, "a": [ 1 ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 15, "a": [ 1, { "b": 3 } ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 16, "a": [ null, { "b": 4 } ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 17, "a": [ {}, { "b": 3 } ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 18, "a": [ { "c": 1 } ] }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 19, "a": [ { "c": 1 }, { "b": 3 } ] }');

-- baseline 
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 20, "a": { "b": 0 } }');
select * from documentdb_api.insert_one('comp_ordind_db', 'sortcoll', '{ "_id": 21, "a": { "b": { "$minKey": 1 } } }');

-- test ordering in the composite index
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "sortcoll", "indexes": [ { "key": { "a.b": 1, "_id": 1 }, "enableCompositeTerm": true, "name": "a.b_1" }] }', true);
...
reset documentdb.forceDisableSeqScan;
select COUNT(documentdb_api.insert_one('comp_ordind_db', 'idIndexOrder', FORMAT('{ "_id": %s, "a": %s }', i , i)::bson)) FROM generate_series(1, 100) AS i;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "idIndexOrder", "indexes": [ { "key": { "_id": 1 }, "enableCompositeTerm": true, "name": "id_2" }] }', true);
...
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 1, "a": { "b": { "c": 1 } } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 2, "a": { "b": [ { "c": 2 } ] } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 3, "a": [ { "b": [ { "c": 1 } ] } ] }');

-- combinations of those paths going missing
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 4, "a": { "b": { "d": 1 } } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 5, "a": { "b": [ { "c": 2 }, {} ] } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 6, "a": { "b": [ { "c": 2 }, 2 ] } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 7, "a": { "b": [ 2 ] } }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 8, "a": { "b": [ {} ] } }');

SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 9, "a": [ { "b": { "c": 3 } }, { "b": { "d": 1 } } ] }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 10, "a": [ { "b": { "c": 3 } }, { "b": 2 } ] }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 11, "a": [ { "b": { "c": 3 } }, {  } ] }');
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 12, "a": [ { "b": { "c": 3 } }, 1 ] }');

-- baseline
SELECT * FROM documentdb_api.insert_one('comp_ordind_db', 'sortcoll3', '{ "_id": 13, "a": { "b": { "c": 0 } } }');

set documentdb.forceDisableSeqScan to on;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "sortcoll3", "indexes": [ { "key": { "a.b.c": 1, "_id": 1 }, "enableCompositeTerm": true, "name": "a.b.c_1" }] }', true);
...
SELECT documentdb_api.insert_one('comp_ordind_db', 'large_keys', FORMAT('{ "_id": 1, "a": "%s" }', repeat('a', 9999) || 'bb')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'large_keys', FORMAT('{ "_id": 2, "a": "%s" }', repeat('a', 9999) || 'cb')::bson);
SELECT documentdb_api.insert_one('comp_ordind_db', 'large_keys', FORMAT('{ "_id": 3, "a": "%s" }', repeat('a', 9999) || 'ab')::bson);

-- 4 does not match
SELECT documentdb_api.insert_one('comp_ordind_db', 'large_keys', FORMAT('{ "_id": 4, "a": "%s" }', repeat('a', 9999) || 'ac')::bson);
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "large_keys", "indexes": [ { "key": { "a": 1 }, "enableCompositeTerm": true, "name": "a_2" }] }', true);
...
reset documentdb.forceDisableSeqScan;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "sortcoll3", "indexes": [ { "key": { "a.b.c": -1, "_id": -1 }, "enableCompositeTerm": true, "name": "a.b.c_-1" }] }', true);
...
reset documentdb.forceDisableSeqScan;
CALL documentdb_api.drop_indexes('comp_ordind_db', '{ "dropIndexes": "sortcoll3", "index": "a.b.c_-1" }');
CALL documentdb_api.drop_indexes('comp_ordind_db', '{ "dropIndexes": "sortcoll", "index": "a.b_-1" }');

-- recreate with mixed asc/desc
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "sortcoll3", "indexes": [ { "key": { "a.b.c": 1, "_id": -1 }, "enableCompositeTerm": true, "name": "a.b.c_1_id-1" }] }', true);
...
reset documentdb.forceDisableSeqScan;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "ordering_groups", "indexes": [ { "key": { "a": 1 }, "enableOrderedIndex": true, "name": "a_1" }] }', true);

-- a is either 0 or 1 or 2
select COUNT(documentdb_api.insert_one('comp_ordind_db', 'ordering_groups', FORMAT('{ "_id": %s, "a": %s }', i , i % 3)::bson)) FROM generate_series(1, 100) AS i;

SELECT collection_id AS collection_id_5 FROM documentdb_api_catalog.collections WHERE collection_name = 'ordering_groups' AND database_name = 'comp_ordind_db' \gset
...
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "compOrderSkip", "indexes": [ { "key": { "a": 1, "b": 1, "c": 1, "d": 1}, "name": "idx1", "enableOrderedIndex": true } ] }');
...
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "index_orderby_selection", "indexes": [ { "key": { "a": 1, "b": 1, "d": 1 }, "enableOrderedIndex": true, "name": "a_b_d_1" }] }', true);

-- insert 100 docs
select COUNT(documentdb_api.insert_one('comp_ordind_db', 'index_orderby_selection', FORMAT('{ "_id": %s, "a": %s, "b": %s, "c": %s, "d": %s }', i, i % 3, i % 10, i % 100, i )::bson)) FROM generate_series(1, 100) AS i;
SELECT collection_id AS collection_id_6 FROM documentdb_api_catalog.collections WHERE collection_name = 'index_orderby_selection' AND database_name = 'comp_ordind_db' \gset
...
CALL documentdb_api.drop_indexes('comp_ordind_db', '{ "dropIndexes": "index_orderby_selection", "index": "a_b_d_1" }');
...
CALL documentdb_api.drop_indexes('comp_ordind_db', '{ "dropIndexes": "index_orderby_selection", "index": "a_b_d_1" }');
SELECT collection_id AS collection_id_6 FROM documentdb_api_catalog.collections WHERE collection_name = 'index_orderby_selection' AND database_name = 'comp_ordind_db' \gset
TRUNCATE documentdb_data.documents_:collection_id_6;
ANALYZE documentdb_data.documents_:collection_id_6;
...
SELECT COUNT(documentdb_api.insert_one('comp_ordind_db', 'testbitmaponorder', FORMAT('{ "_id": %s, "a": "%s%s", "b": "%s%s" }', i, repeat('a', 10000), i, repeat('a', 10000), i)::bson)) FROM generate_series(1, 10000) i;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "testbitmaponorder", "indexes": [ { "key": { "b": 1, "c": 1, "a": 1 }, "name": "b_c_a_1", "enableOrderedIndex": true } ] }', TRUE);

SELECT documentdb_distributed_test_helpers.drop_primary_key('comp_ordind_db', 'testbitmaponorder');

SELECT collection_id AS collection_id_7 FROM documentdb_api_catalog.collections WHERE collection_name = 'testbitmaponorder' AND database_name = 'comp_ordind_db' \gset

\d documentdb_data.documents_:collection_id_7

ANALYZE documentdb_data.documents_:collection_id_7;
...
SELECT documentdb_api.insert_one('comp_ordind_db', 'no_prefix_scan', '{ "_id": 1, "a": 1, "b": "a" }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'no_prefix_scan', '{ "_id": 2, "a": 1, "b": "o" }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'no_prefix_scan', '{ "_id": 3, "a": 2, "b": "o" }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'no_prefix_scan', '{ "_id": 4, "a": 2, "b": "a" }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'no_prefix_scan', '{ "_id": 5, "a": 3, "b": "a" }');

reset work_mem;
reset enable_indexscan;
reset enable_bitmapscan;
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "no_prefix_scan", "indexes": [ { "key": { "a": 1, "b": 1 }, "name": "a_b_1", "enableOrderedIndex": true } ] }', true);

SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "no_prefix_scan", "filter": { "b": "o" }, "sort": { "a": 1 } }');
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "no_prefix_scan", "filter": { "b": "o" }, "sort": { "a": -1 } }');


SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 0, "data": [ { "value": { "$minKey": 1 } }, { "value": { "$maxKey": 1 } } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 1, "data": [ { "value": 3 }, { "value": 4.1 } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 2, "data": [ { "value": 4 }, { "value": 5 } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 3, "data": [ { "value": { "$numberDouble": "-Infinity" } }, { "value": { "$numberDouble": "Infinity" } } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 4, "data": { "value": [] } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 5, "data": { "value": [4, 7] } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 6, "data": [] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 7, "data": [ { "value": null } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 8, "data": { "value": null } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 9, "data": { "value": "\u0000" } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 10, "data": { "value": [ "\u0000" ] } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 11, "data": { "value": [ [ "\u0000" ], "" ] } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 12, "data": [ { "value": "\u0000" } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 13, "data": [ { "value": "" }, { "value": "\u0000" } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 14, "data": { "value": { "nested": "\u0000" } } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 15, "data": { "value": { "nested": [ "\u0000" ] } } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 16, "data": { "value": { "nested": { "deep": "\u0000" } } } }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 17, "data": [ { "value": [ "" ] }, { "value": [ "\u0000" ] } ] }');
SELECT documentdb_api.insert_one('comp_ordind_db', 'basic_sort_order', '{ "_id": 18, "data": [ { "value": { "nested": "" } }, { "value": { "nested": "\u0000" } } ] }');

-- expected order is [0, 4, 6, [8, 7], 3, 1, [2, 5], [13, 17, 11], [9, 12, 10], 18, 14, 16, 15]
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "basic_sort_order", "filter": {}, "sort": { "data.value": 1, "_id": -1 } }');

-- expected order is [0, 11, 15, 16, [18, 14], [12, 10, 17, 13, 9], 3, 5, 2, 1, [7, 8], [6, 4]]
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "basic_sort_order", "filter": {}, "sort": { "data.value": -1, "_id": 1 } }');
...
SELECT documentdb_api_internal.create_indexes_non_concurrently('comp_ordind_db', '{ "createIndexes": "basic_sort_order", "indexes": [ { "key": { "data.value": 1, "_id": -1 }, "enableOrderedIndex": true, "name": "data_value_1" }] }', true);

set documentdb.forceDisableSeqScan to on;
-- expected order is [0, 4, 6, [8, 7], 3, 1, [2, 5], [13, 17, 11], [9, 12, 10], 18, 14, 16, 15]
SELECT document FROM bson_aggregation_find('comp_ordind_db', '{ "find": "basic_sort_order", "filter": {}, "sort": { "data.value": 1 } }');
